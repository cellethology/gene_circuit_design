...
STRATEGY_COLORS = {
    "highExpression": "#d62728",  # Red
    "log_likelihood": "#ff7f0e",  # Orange
    "random": "#2ca02c",  # Green
    "kmeans_random": "#9467bd",  # Purple
    "kmeans_high_expression": "#1f77b4",  # Blue
}
...
def main():
    ...
    print(f"Results folders: {results_folders}")

    for folder in results_folders:
        try:
            visualize_folder(
                folder_path=folder,
                output_dir=output_dir / folder.parent.name / folder.name,
