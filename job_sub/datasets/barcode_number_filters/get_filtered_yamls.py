"""
generate a YAML file automatically for running experiments over all *_indices.txt files in barcode_number_filters/
the yaml file will be like this:
datasets:
  - name: "job_sub/datasets/barcode_number_filters/166k_filtered_n>=0_indices.txt"
    ...
    subset_ids_path: "/home/wangzitongLab/liuxuyin/barcode_number_filters/166k_filtered_n>=14_indices.txt"
...
if __name__ == "__main__":
    subset_dir = Path(__file__).parent.resolve()
    output_yaml = subset_dir / "subsets_by_barcode_datasets.yaml"
    metadata_path = "/storage2/wangzitongLab/share/gene_circuit_design_data/data_new/Rai_2024_166k/166k_Library_CLASSIC_Data.csv"
    embedding_dir = "/storage2/wangzitongLab/share/gene_circuit_design_data/data_new/Rai_2024_166k"
